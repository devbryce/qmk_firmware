...
const Layer_Info layer_info[] = {
    ...
    {0x00000000, 0xFFFFFFFF, {0xFF, 0x00, 0x00}}, // base layers - red
    {0x00000002, 0xFFFFFFFE, {0x00, 0x00, 0xFF}}, // function layer - blue
    {0x00000004, 0xFFFFFFFC, {0x00, 0xFF, 0x00}}, // settings layer - green
...
[VANILLA] = LAYOUT(
    ...
    * ,------------------------------------------------------------------------------.
    * |Esc| 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9 |  0| - | = |Backsp |  |NmL|  /|  *|  -|
    * |------------------------------------------------------------------------------|
    * |Tab  |  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|    \|  |  7|  8|  9|  +|
    * |------------------------------------------------------------------------------|
    * |Caps   |  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|Return |  |  4|  5|  6|Del|  
    * |------------------------------------------------------------------------------|
    * |Shift   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /| Shift  | Up |  1|  2|  3|   |
    * |--------------------------------------------------------------------------|Ent| 
    * |Ctrl|Gui |Alt |      Space            |ALT|Func|CTRL| Lt | Dn |Rig|  O|  .|   |
    * `------------------------------------------------------------------------------'
    */
  KC_GESC,  KC_1,    KC_2,    KC_3,   KC_4,    KC_5,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,  KC_DEL,  KC_PSLS, KC_PAST, KC_NLCK,
  KC_TAB,   KC_Q,    KC_W,    KC_E,   KC_R,    KC_T,  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,  KC_P7,   KC_P8,   KC_P9,   KC_PMNS,
  MO(FUNC), KC_A,    KC_S,    KC_D,   KC_F,    KC_G,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,   KC_P4,   KC_P5,   KC_P6,   KC_PPLS,
  KC_LSFT,  KC_Z,    KC_X,    KC_C,   KC_V,    KC_B,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, KC_UP,    KC_P1,   KC_P2,   KC_P3,   KC_PENT,
  KC_LCTL,  KC_LGUI, KC_LALT,                  KC_SPC,                           KC_RALT, MO(FUNC),KC_RCTL, KC_LEFT, KC_DOWN,  KC_RGHT, KC_P0,   KC_PDOT),
    /* Keymap FUNCTION: Function Layer
    * ,------------------------------------------------------------------------------.
    * |Grv| F1| F2| F3| F4| F5| F6| F7| F8| F9|F10|F11|F12|  Del  |  |Tog| S+| H+| V+| <- RGB Underglow Controls
    * |------------------------------------------------------------------------------|
    * |Caps |Hom| Up|End|PgU|   |   |   |Ins|   |PrS|BL-| BL+|BLTG|  |Mod| S-| H-| V-| <- RGB Underglow Controls
    * |------------------------------------------------------------------------------|
    * |       | Lt| Dn| Rt|PgD|   |   |   |   |   |   |   |       |  |   |   |   |   |  
    * |------------------------------------------------------------------------------|
    * |        |   |Cal|   |   |   |   |Mut| V-| V+|   |Settings|    |   |   |   |   |
    * |--------------------------------------------------------------------------|   | 
    * |    |    |    |                       |   |Func|    |    |    |   |   |   |   |
    * `------------------------------------------------------------------------------'
    */
[FUNC] = LAYOUT(
  ...
  KC_TR,    KC_TR,   KC_TR,                    KC_TR,                            KC_TR,   KC_TR,   KC_TR,   KC_TR,   KC_TR,    KC_TR,   KC_TR,   KC_TR),
    ...
    * ,------------------------------------------------------------------------------.
    * |   |   |   |   |   |   |   |   |   |   |   |   |   |       |  |Tog| S+| H+| V+| <- RGB Underglow Controls
    * |------------------------------------------------------------------------------|
    * |MUSC |   |   |   |   |   |   |   |   |   |   |BL-| BL+|BLTG|  |Mod| S-| H-| V-| <- RGB Underglow Controls
    * |------------------------------------------------------------------------------|
    * |AudTgl |Hz+|MS+|   |   |   |   |   |   |   |   |   |  RST  |  |   |   |   |   |  
    * |------------------------------------------------------------------------------|
    * |ClickTgl|Hz-|MS-|   |   |   |   |MUT|   |   |   |Settings|    |   |   |   |   |
    * |--------------------------------------------------------------------------|   | 
    * |    |    |    |                       |   |    |    |    |    |   |   |   |   |
    * `------------------------------------------------------------------------------'	
    */
[SETTINGS] = LAYOUT(
    KC_FN0, KC_NO,   KC_NO,   KC_NO,  KC_NO,   KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,    RGB_TOG, RGB_SAI, RGB_HUI, RGB_VAI,
    MU_MOD, KC_NO,   KC_NO,   KC_NO,  KC_NO,   KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   BL_DEC,  BL_INC,  BL_TOGG,  RGB_MOD, RGB_SAD, RGB_HUD, RGB_VAD,
    AU_TOG, KC_FN1,  KC_FN3,  KC_NO,  KC_NO,   KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,            RESET,    KC_NO,   KC_NO,   KC_NO,   KC_NO,
    KC_FN5, KC_FN2,  KC_FN4,  KC_NO,  KC_NO,   KC_NO, KC_NO,   MU_TOG,  KC_NO,   KC_NO,   KC_NO,            KC_NO,   KC_NO,    KC_NO,   KC_NO,   KC_NO,   KC_NO,
